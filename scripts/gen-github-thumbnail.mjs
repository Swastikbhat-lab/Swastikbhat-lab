/**
 * Render github-thumbnail.html to assets/github-thumbnail.png
 ...
 *
 * Run: node scripts/gen-github-thumbnail.mjs
 */
import { resolve } from 'node:path';
import { repoRoot, renderPng } from './lib/playwright.mjs';

const htmlPath = resolve(repoRoot, 'github-thumbnail.html');
const outPath = resolve(repoRoot, 'assets', 'github-thumbnail.png');
